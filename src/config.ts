export const CONFIG = {
  ...
  milestones: [
    ...
    { date: new Date(2025, 11, 28), label: 'Hospital Scan', emoji: '🏥', color: 'subtle', description: 'Confirmed heartbeat and normal implantation' },
    { date: new Date(2026, 0, 6), label: 'Dr Rodin', emoji: '👨‍⚕️', color: 'subtle', description: 'Given your history, a biological gift!' },
    { date: new Date(2026, 0, 8), label: 'NHS Self Referral', emoji: '📉', color: 'subtle', description: 'Chance of miscarriage now below 5%' },
    { date: new Date(2026, 0, 12), label: "León's Birthday", emoji: '🎂', color: 'subtle' },
    { date: new Date(2026, 0, 19), label: 'Flu Jab', emoji: '💉', color: 'subtle' },
    { date: new Date(2026, 0, 23), label: 'Blood Tests', emoji: '🩸', color: 'subtle', description: '10 week blood tests which should reveal gender and any adverse genetic issues at The Fetal Medicine Centre' },
    { date: new Date(2026, 0, 29), label: "Yael's Birthday", emoji: '🎂', color: 'subtle' },
    ...
    { date: new Date(2026, 2, 10), label: "James' Baby Due", emoji: '🐣', color: 'subtle' },
    { date: new Date(2026, 2, 15), endDate: new Date(2026, 2, 20), label: 'Madrid Offsite', emoji: '🇪🇸', color: 'gold', description: '15 - 20 Mar' },
    { date: new Date(2026, 2, 28), endDate: new Date(2026, 3, 13), label: 'Easter Holidays', emoji: '🏝️', color: 'subtle', description: 'School resumes 14 Apr' },
    { date: new Date(2026, 2, 29), label: "Vishal's Baby Due", emoji: '🐣', color: 'subtle' },
    { date: new Date(2026, 3, 12), label: 'Engagement Party', emoji: '🎉', color: 'orange' },
    { date: new Date(2026, 3, 26), label: "Seb's Baby Due", emoji: '🐣', color: 'subtle' },
    { date: new Date(2026, 4, 8), endDate: new Date(2026, 4, 11), label: "Daniel's Stag", emoji: '🎩', color: 'gold', description: '8 - 11 May' },
    { date: new Date(2026, 4, 23), endDate: new Date(2026, 4, 31), label: 'May Half Term', emoji: '🏝️', color: 'subtle', description: 'School resumes 1 June' },
