export const CONFIG = {
  ...
  milestones: [
    ...
    { date: new Date(2026, 1, 12), label: 'Announce!', emoji: '📢', color: 'purple', description: 'Start of second trimester (week 13)' },
    ...
    { date: new Date(2026, 6, 12), label: 'Anakha Wedding', emoji: '🦖', color: 'pink' },
