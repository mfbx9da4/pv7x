export const CONFIG = {
  ...
  milestones: [
    ...
    { date: new Date(2026, 0, 8), label: 'NHS Self Referral', emoji: '📉', description: 'Chance of miscarriage now below 5%' },
    { date: new Date(2026, 0, 12), label: "León's Birthday", emoji: '🎂' },
    { date: new Date(2026, 0, 19), label: 'Flu Jab', emoji: '💉' },
    ...
    { date: new Date(2026, 2, 28), endDate: new Date(2026, 3, 13), label: 'Easter Holidays', emoji: '🏝️', description: 'School resumes 14 Apr' },
    ...
    { date: new Date(2026, 4, 23), endDate: new Date(2026, 4, 31), label: 'May Half Term', emoji: '🏝️', description: 'School resumes 1 June' },
    ...
    { date: new Date(2026, 5, 24), label: "Charlie's Wedding", emoji: '💒', color: 'pink' },
