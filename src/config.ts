export const CONFIG = {
  ...
  milestones: [
    ...
    { date: new Date(2026, 0, 8), label: '<5% Miscarriage', emoji: '📉', description: 'Chance of miscarriage now below 5%' },
    ...
    { date: new Date(2026, 2, 15), label: 'Madrid Offsite', emoji: '🇪🇸', color: 'gold', description: '15 - 20 Mar' },
    ...
    { date: new Date(2026, 4, 8), label: "Daniel's Stag", emoji: '🎩', color: 'gold', description: '8 - 11 May' },
    { date: new Date(2026, 4, 23), label: 'May Half Term', emoji: '🏝️', description: 'School resumes 1 June' },
