export const CONFIG = {
  ...
  milestones: [
    ...
    { date: new Date(2026, 1, 14), label: 'Half Term Start', emoji: '🏝️', description: 'School resumes 23 Feb' },
    { date: new Date(2026, 2, 10), label: "James' Baby Due", emoji: '🐣' },
    { date: new Date(2026, 2, 28), label: 'Spring Holidays Start', emoji: '🏝️', description: 'School resumes 14 Apr' },
    ...
    { date: new Date(2026, 4, 23), label: 'Half Term Start', emoji: '🏝️', description: 'School resumes 1 June' },
