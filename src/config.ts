export const CONFIG = {
  ...
  milestones: [
    ...
    { date: new Date(2026, 1, 14), label: 'School Half Term (Feb)', emoji: '🏫', description: 'School half term until 22 Feb' },
    { date: new Date(2026, 2, 10), label: "James' Baby Due", emoji: '🐣' },
    { date: new Date(2026, 2, 28), label: 'School Half Term (Mar/Apr)', emoji: '🏫', description: 'School half term until 13 Apr' },
